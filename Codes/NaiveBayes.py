...
true_test_data["Class(Target)"] = pred
true_test_data.to_csv('Test_NB.csv', index=False)

test_raw = pd.read_csv('Test.csv')
test_raw["Class(Target)"] = pred
test_raw.to_csv('Test_NB.csv', index=False)

val_raw = pd.read_csv('Validate.csv')
val_raw["Pred"] = predictions
val_raw.to_csv('Validate_NB.csv', index=False)
train_raw = pd.read_csv('Train.csv')
pred_train = model.predict(X_train)
train_raw["Pred"] = pred_train
train_raw.to_csv('Train_NB.csv', index=False)