...
df_test["RF1"] = test_RF["Class(Target)"]
df_test["RF2"] = test_RF["Class(Target)"]
df_test["RF3"] = test_RF["Class(Target)"]
df_test["RF4"] = test_RF["Class(Target)"]
df_test["RF5"] = test_RF["Class(Target)"]
df_test["RF6"] = test_RF["Class(Target)"]
...
test_raw.to_csv("Test_Integration_MajorityVoteWithWeight.csv", index=False)